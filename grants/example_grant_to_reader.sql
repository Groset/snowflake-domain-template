...
GRANT USAGE ON SCHEMA <PRIMARY_SCHEMA>
    TO ROLE BSL_DEFAULT_ROLE;

GRANT SELECT ON ALL TABLES IN SCHEMA <PRIMARY_SCHEMA>
    TO ROLE BSL_DEFAULT_ROLE;

GRANT SELECT ON FUTURE TABLES IN SCHEMA <PRIMARY_SCHEMA>
    TO ROLE BSL_DEFAULT_ROLE;

GRANT SELECT ON ALL VIEWS IN SCHEMA <PRIMARY_SCHEMA>
    TO ROLE BSL_DEFAULT_ROLE;

GRANT SELECT ON FUTURE VIEWS IN SCHEMA <PRIMARY_SCHEMA>
    TO ROLE BSL_DEFAULT_ROLE;
...
--
-- GRANT USAGE  ON SCHEMA  <PRIMARY_SCHEMA> TO ROLE PC_DOMO_ROLE;
-- GRANT SELECT ON ALL    TABLES IN SCHEMA <PRIMARY_SCHEMA> TO ROLE PC_DOMO_ROLE;
-- GRANT SELECT ON FUTURE TABLES IN SCHEMA <PRIMARY_SCHEMA> TO ROLE PC_DOMO_ROLE;
-- GRANT SELECT ON ALL    VIEWS  IN SCHEMA <PRIMARY_SCHEMA> TO ROLE PC_DOMO_ROLE;
-- GRANT SELECT ON FUTURE VIEWS  IN SCHEMA <PRIMARY_SCHEMA> TO ROLE PC_DOMO_ROLE;
